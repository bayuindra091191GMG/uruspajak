...
@section('content')
    ...
    <header class="blue accent-3 relative nav-sticky">
        <div class="container-fluid text-white">
            <div class="row mb-3 ">
                <div class="col-12">
                    <h4> <i class="icon-settings2"></i> Customize Cara Kerja</h4>
                </div>
            </div>
    ...
    <div class="animatedParent animateOnce">
        <div class="container-fluid my-3">
            ...
            {{ Form::open(['route'=>['admin.carakerja.update'],'method' => 'post','id' => 'general-form']) }}
            <div class="row mb-5">
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-body b-b">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h3 class="float-left">Cara Kerja 1 Contents</h3>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-body b-b">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h3 class="float-left">Cara Kerja 2 Contents</h3>
                                    {{-- <button type="button" class="btn btn-success float-right content-add" data-column="2">
                                        <i class="icon-plus"></i>
                                    </button> --}}
                                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-body b-b">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h3 class="float-left">Cara Kerja 3 Contents</h3>
                                    {{-- <button type="button" class="btn btn-success float-right content-add" data-column="2">
                                        <i class="icon-plus"></i>
                                    </button> --}}
                                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-body b-b">
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h3 class="float-left">Cara Kerja 4 Contents</h3>
                                    {{-- <button type="button" class="btn btn-success float-right content-add" data-column="2">
                                        <i class="icon-plus"></i>
                                    </button> --}}
                                </div>
    ...
    <div id="editModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['route'=>['admin.carakerja.update'],'method' => 'post','id' => 'form_column_item_update']) }}
                    <div class="form-group">
                        <label for="edited_title" class="col-form-label">Title</label>
                        <textarea class="form-control" id="edited_title" name="edited_title" rows="3"></textarea>   
                    </div>
                    <div class="form-group">
    ...
    {{-- <div id="deleteModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['route'=>['admin.carakerja.item.destroy'],'method' => 'post','id' => 'form_column_item_delete']) }}
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.content-edit', function(){
            ...
            $('#edited_title').val($(this).data('title'));
